                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="mr-5 mb-4">
                                                    ...
                                                    <p class="text-dark h5 font-weight-normal">
                                                        {{"({$curriculo->telefone->ddd}) {$curriculo->telefone->numero}"}}
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-wrap">
                                            ...
                                            @foreach ($curriculo->formacoes as $formacao)
                                                <div
                                                    ...
                                                    <div role="group" class="btn-group">
                                                        <button type="button"
                                                                class="btn btn-light"><span aria-label="Pencil icon"
                                                                                            role="img"
                                                        ...
                                                        <button type="button"
                                                                class="btn btn-light"><span aria-label="Delete icon"
                                                                                            role="img"
                                                ...
                                                <p class="text-muted">
                                                    ...
                                                    <span>{{
                                                        isset($formacao->previsao_fim) ?
                                                        '(Previsão de término em '.Carbon\Carbon::createFromFormat('Y-m-d', $formacao->previsao_fim)->year.')' :
                                                        Carbon\Carbon::createFromFormat('Y-m-d', $formacao->previsao_fim)->year}}
                                                    </span>
                                                </p>
                                            @endforeach
                                        </div>
                                            ...
                                            @foreach($curriculo->experiencias as $experiencia)
                                                <div
                                                    ...
                                                    <div role="group" class="btn-group">
                                                        <button type="button"
                                                                class="btn btn-light">
                                                        <span aria-label="Pencil icon" role="img"
                                                              class="material-design-icon pencil-icon align-text-bottom text-blue-ml">
                                                ...
                                                <p class="text-muted">
                                                    ...
                                                    <span>
                                                    - {{ $experiencia->ehAtual ? "Atualmente" : Carbon\Carbon::createFromFormat('Y-m-d', $experiencia->saida)->year }}
                                                    ...
                                                    <div tabindex="-1" role="document"
                                                        ...
                                                        <div id="__BVID__141___BV_modal_body_" class="modal-body">
                                                            <div class="py-4 px-2 px-lg-4">
                                                                <h4 class="text-blue-ml mb-4">EXPERIÊNCIA
                                                                    PROFISSIONAL</h4>
                                                                ...
                                                                <form data-v-2ddf7319="" novalidate="novalidate">
                                                                        ...
                                                                        <div data-v-2ddf7319=""
                                                                            ...
                                                                            <div data-v-2ddf7319=""
                                                                                ...
                                                                                <input data-v-2ddf7319=""
                                                                                    ...
                                                                                    class="custom-control-label">Meu
                                                                                    cargo
                                                                                    atual</label>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div data-v-2ddf7319=""
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            class="btn btn-light mr-auto">Cancelar
                                                                        </button>
                                                                        <button
                                                                            data-v-2ddf7319="" type="submit"
                                                                            class="btn btn-blue-ml">Salvar
                                                                        </button>
                                                                    </div>
                                                                </form>
                                                            </div>
